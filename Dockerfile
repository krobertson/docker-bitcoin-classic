...
ENV GLIBC_VERSION=2.25-r0 \
    BITCOIN_VERSION=1.2.3 \
    BITCOIN_URL=https://github.com/bitcoinclassic/bitcoinclassic/releases/download/v1.2.3/bitcoin-1.2.3-linux64.tar.gz \
    BITCOIN_SHA256=9eaa9a2ad72199f314a558b24424575084368ce5866bfbbb1a85429cd8fe67f8 \
    BITCOIN_ASC_URL=https://github.com/bitcoinclassic/bitcoinclassic/releases/download/v1.2.3/SHA256SUMS.asc \
